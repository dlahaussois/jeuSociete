...
public class JeuxDeSocieteApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		JeuLocation jl6 = new JeuLocation(null, 15.00, j6);
		JeuLocation jl7 = new JeuLocation(null, 15.00, j7);
		JeuLocation jl8 = new JeuLocation(null, 10.00, j8);
		JeuLocation jl9 = new JeuLocation(null, 8.00, j9);
		JeuLocation jl10 = new JeuLocation(null, 15.00, j10);
		JeuLocation jl11 = new JeuLocation(null, 8.00, j11);
		Stream.of(jl1,jl2,jl3,jl4,jl5,jl6,jl7,jl8,jl9,jl10,jl11).forEach(jl -> jlRepo.save(jl));
